...
function api_action_handlers(): array
{
    ...
    $handlers = [
        ...
        'remove_trip_member' => 'remove_trip_member_action',
        'leave_trip' => 'leave_trip_action',
        'update_trip_member_role' => 'update_trip_member_role_action',
        'users' => 'users_action',
        ...
        'cancel_settlement_sent' => 'cancel_settlement_sent_action',
        'report_settlement_not_received' => 'report_settlement_not_received_action',
        ...
        'list_trip_activity' => 'list_trip_activity_action',
