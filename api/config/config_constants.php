...
define(
    ...
    env_string(
        ...
        'trip_finished,trip_ready_to_settle,settlement_sent,settlement_confirmed,expense_added,friend_invite_received'
    )
);
...
define('RATE_LIMIT_COMMENT_WRITE_IP_MAX', env_int('TRIP_RATE_LIMIT_COMMENT_WRITE_IP_MAX', 300));
define('RATE_LIMIT_COMMENT_WRITE_USER_MAX', env_int('TRIP_RATE_LIMIT_COMMENT_WRITE_USER_MAX', 200));
...
define('RATE_LIMIT_ADMIN_PANEL_LOGIN_IP_MAX', env_int('TRIP_RATE_LIMIT_ADMIN_PANEL_LOGIN_IP_MAX', 20));
define('RATE_LIMIT_ADMIN_PANEL_LOGIN_USERNAME_MAX', env_int('TRIP_RATE_LIMIT_ADMIN_PANEL_LOGIN_USERNAME_MAX', 10));
define('RATE_LIMIT_ADMIN_PANEL_2FA_IP_MAX', env_int('TRIP_RATE_LIMIT_ADMIN_PANEL_2FA_IP_MAX', 24));
define('RATE_LIMIT_ADMIN_PANEL_2FA_TOKEN_MAX', env_int('TRIP_RATE_LIMIT_ADMIN_PANEL_2FA_TOKEN_MAX', 12));
...
define('RATE_LIMIT_ADMIN_PANEL_WINDOW_SEC', env_int('TRIP_RATE_LIMIT_ADMIN_PANEL_WINDOW_SEC', 900));

define('ADMIN_PANEL_SESSION_TTL_SEC', max(900, min(28800, env_int('TRIP_ADMIN_PANEL_SESSION_TTL_SEC', 7200))));
